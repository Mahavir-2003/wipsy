...
export const metadata = {
  title: "Wipsy - Secure Temporary Code & Note Sharing Platform",
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://wipsy.vercel.app",
    images: [
      {
        url: "/og-image.jpg", // You'll need to add this image
        width: 1200,
        height: 630,
        alt: "Wipsy - Temporary Code & Note Sharing Platform",
      },
    ],
  },
  twitter: {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="application-name" content="Wipsy" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black" />
        <meta name="apple-mobile-web-app-title" content="Wipsy" />
        <meta name="format-detection" content="telephone=no" />
        <meta name="mobile-web-app-capable" content="yes" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://wipsy.vercel.app" />
